                                ...
                                <table class="tabel table-bordered tablehover table-striped">
                                  ...
                                  <tbody>
                                    ...
                                    foreach ($transaksi as $p) {
                                      ?>
                                      <tr>
                                        <td><?php echo date('d/m/Y',strtotime($p->tanggal_input)); ?></td><!-- Rubah tgl_pencatatan menjadi tanggal_input -->
                                        <td><?php echo date('d/m/Y',strtotime($p->tgl_pinjam)); ?></td>
                                        <td><?php echo date('d/m/Y',strtotime($p->tgl_kembali)); ?></td>
                                        <td><?php echo "Rp. ".number_format($p->totaldenda)." ,-"; ?></td> <!-- Rubah total_denda menjadi totaldenda -->
                                      </tr>
                                    <?php } ?>
                                  </tbody>
                                </table>
