...
class Admin extends CI_Controller
{
  ...
  function index(){
	// edit from table transaksi menjadi from peminjaman
  ...
  function ganti_password_act(){
    ...
    function tambah_anggota_act(){
      ...
      function peminjaman(){
        //rubah query, edit dan arahkan ke tabel peminjaman
      ...
      function tambah_peminjaman_act(){
        ...
        function transaksi_hapus($id){
          ...
          $this->M_perpus->delete_data($w,'detail_pinjam');
          redirect(base_url().'admin/peminjaman');
        }
        ...
        function transaksi_selesai_act(){
          ...
          if($this->form_validation->run() !=false){
            ...
            $selisih = abs(($dikembalikan-$batas_kembali)/(60*60*24));//edit 1
            ...
            $w = array('id_pinjam' =>$id);
            $this->M_perpus->update_data('peminjaman',$data,$w);//edit 3
            //update status Buku
            $data2 = array('status_buku' => '1');
