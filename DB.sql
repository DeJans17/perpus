...
MySQL - 10.1.37-MariaDB : Database - ajar_perpusmahasiswa
*********************************************************************
*/
...
insert  into `admin`(`id_admin`,`nama_admin`,`username`,`password`) values (1,'Nawawi','admin','827ccb0eea8a706c4c34a16891f84e7b'),(2,'Imam Nawawi','imam','200ceb26807d6bf99fd6f4f0d1ca54d4'),(3,'Rino Ramadan','admin','21232f297a57a5a743894a0e4a801fc3');
